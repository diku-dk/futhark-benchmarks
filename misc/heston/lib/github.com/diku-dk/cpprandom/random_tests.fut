...
module mktest_f (dist: rng_distribution) (R: real with t = dist.num.t) = {
  ...
  let test (x: i32) (n: i32) (d: dist.distribution) =
    ...
    let stddev = R.((xs
                     ...
                     |> sum) / i32 n
                    |> sqrt)
    in (x, R.round mean, R.round stddev)
}
...
-- compiled input { 1 10000 } output { 36.858000f32 50.43502f32 }
...
-- compiled input { 0 10000 } output { 238.47754f32 50f32 25f32 }
-- compiled input { 1 10000 } output { 149.30188f32 50f32 25f32 }
...
-- compiled input { 0 10000 } output { 61.233223f32 50f32 25f32 }
-- compiled input { 1 10000 } output { 41.309757f32 50f32 25f32 }
