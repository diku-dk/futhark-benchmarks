entry main [m'] [N']
  ...
  let total_flops =
    mkX_flops + bmmm_flops + bminv_flops + mmm1_flops + mmm2_flops + mmm3_flops
    + filtpad_flops
    + sgmred_flops
    + mvsfst_flops
    + bound_flops
    + res_flops
  let total_bytes =
    (mkX_words + bmmm_words + bminv_words + mmm1_words + mmm2_words + mmm3_words
     + filtpad_words
     + sgmred_words
     + mvsfst_words
     + bound_words
