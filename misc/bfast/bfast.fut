...
let bfast [N] (f: f32) (k: i32) (n: i32) 
  ...
  let breaks = map2 (\m b -> if (f32.isnan m) || (f32.isnan b) then 0.0f32 else (f32.abs m) - b) MO BOUND
  in  breaks
...
--FUTHARK_INCREMENTAL_FLATTENING=1 ~/WORK/gits/futhark/tools/futhark-autotune --compiler=futhark-opencl --stop-after 700 --calc-timeout bfast-irreg.fut --compiler=futhark-opencl
-- ./bfast-irreg -D --size=suff_intra_par_16526=2174977 --size=suff_outer_par_13585=83452 --size=suff_outer_par_15635=14087708 --size=suff_outer_par_17308=275169  --size=suff_intra_par_17352=126766033 --size=suff_intra_par_14230=681452 --size=suff_intra_par_18603=520150588 --size=suff_outer_par_18557=2175006 --size=suff_intra_par_15678=112684971 --size=suff_outer_par_16487=274502 < data/sahara.in > /dev/null
