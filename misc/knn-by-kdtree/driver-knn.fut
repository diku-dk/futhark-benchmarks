...
def propagate [m] [q] [d] [n]
  ...
  let STEP = 64
  let visited = replicate (num_leaves / STEP) (-1i32)
  --replicate ((h+1)*32) (-1i32)
...
entry mk_input (ppl: i32) (m: i64) (n: i64) (d: i64) =
  ( ppl
  , unflatten (tabulate (m * d) \i ->
                 f32.i32 (hash (i32.i64 i)) / f32.i32 i32.highest)
  , unflatten (tabulate (n * d) \i ->
                 f32.i32 (hash (i32.i64 i)) / f32.i32 i32.highest)
  )
