...
module test_romu_mono32_m = util.mktest (uniform_int_distribution i32 romu_trio32)

entry test_romu_quad (x: i32) (n: i32) = test_romu_quad_m.test x n (1,100)
entry test_romu_trio (x: i32) (n: i32) = test_romu_trio_m.test x n (1,100)
entry test_romu_duo (x: i32) (n: i32) = test_romu_duo_m.test x n (1,100)
entry test_romu_duo_jr (x: i32) (n: i32) = test_romu_duo_jr_m.test x n (1,100)

entry test_romu_quad32 (x: i32) (n: i32) = test_romu_quad32_m.test x n (1,100)
entry test_romu_trio32 (x: i32) (n: i32) = test_romu_trio32_m.test x n (1,100)
entry test_romu_mono32 (x: i32) (n: i32) = test_romu_mono32_m.test x n (1,100)
