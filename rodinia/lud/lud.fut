...
--------------------------------------------
--------------------------------------------
fun lud_perimeter_lower0(step: int, diag: [b][b]f32, mat: [m][m][b][b]f32): *[m][b][b]f32 = copy(mat[0])
...
fun lud_internal1(d:  int, top_per: [mp1][b][b]f32, lft_per: [mp1][b][b]f32, mat: [mp1][mp1][b][b]f32 ): *[][][b][b]f32 =
  let m = mp1 - 1 in
...
fun lud_internal2(d:  int, top_per0t: [mp1][b][b]f32, lft_per0: [mp1][b][b]f32, mat: [mp1][mp1][b][b]f32 ): *[][][b][b]f32 =
  let m = mp1 - 1 in
...
fun lud_internal(d:  int, top_per: [mp1][b][b]f32, lft_per: [mp1][b][b]f32, mat: [mp1][mp1][b][b]f32 ): *[][][b][b]f32 =
  let m = mp1 - 1 in
