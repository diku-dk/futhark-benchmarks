...
def valid_neighbour (random_state: []i64) (C: []i64) (state: i64) (neighbour: i32) : i32 =
  if (C[neighbour] == 1) && (random_state[neighbour] < state)
  then 1
  else 0
...
def MIS [nVerts] (vertexes: [nVerts]i32) (edges: []i32) (random_state: [nVerts]i64) (C: *[nVerts]i64) (I: *[nVerts]i64) (indexes: []i64) (nEdges: i64) =
  -- Loop until every vertex is added to or excluded from the MIS
  let (_, I) =
    loop (C, I) while (i64.sum C) > 0 do
