...
def getMMEdges (smallestEdgeId: []i32) (e: [2]i32) (i: [2]i32) =
    if smallestEdgeId[e[0]] == i[0] && smallestEdgeId[e[1]] == i[0] then ((e, i): ([2]i32, [2]i32)) else ([-1, -1], [-1, -1])

-- Update the marked vertexes and included edges
def update[arraySize] (edges: [arraySize][2]i32) (edge2Ids: [arraySize][2]i32) (smallestEdgeId: []i32) (markedVerts: *[]bool) (includedEdges: *[]bool) =
...
def MM [nVerts] [nEdges] (edges: *[][2]i32) (edgeIds: [nEdges]i64) (edge2Ids: *[][2]i32) (markedVerts: *[nVerts]bool) (smallestEdgeId: *[nVerts]i32) (includedEdges: *[nEdges]bool) =
    let (_, _, _, _, includedEdges) = loop (edges, edge2Ids, markedVerts, smallestEdgeId, includedEdges) while (length edges > 0) do
        ...
        let smallestEdgeId = scatter smallestEdgeId (map ((.0) >-> i64.i32) smallestPairs) (map (.1) smallestPairs)
