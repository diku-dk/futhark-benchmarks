...
def cap (num_bits: i64) (n: i64) : i64 =
  (n - 1) / num_bits + 1i64
...
module type bitset = {
  ...
  --
  -- **Span:** *O(1)*
  val empty : (n: i64) -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(1)*
  val singleton : (n: i64) -> i64 -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(log n)*
  val is_empty [n] : bitset [cap num_bits n] -> bool
  ...
  --
  -- **Span:** *O(1)*
  val member [n] : i64 -> bitset [cap num_bits n] -> bool
  ...
  --
  -- **Span:** *O(1)*
  val union [n] : bitset [cap num_bits n] -> bitset [cap num_bits n] -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(1)*
  val intersection [n] : bitset [cap num_bits n] -> bitset [cap num_bits n] -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(1)*
  val difference [n] : bitset [cap num_bits n] -> bitset [cap num_bits n] -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(log n)*
  val is_subset [n] : bitset [cap num_bits n] -> bitset [cap num_bits n] -> bool
  ...
  --
  -- **Span:** *O(1)*
  val complement [n] : bitset [cap num_bits n] -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(1)*
  val set_capacity [m] : (n: i64) -> bitset [cap num_bits m] -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(log n)*
  val size [n] : bitset [cap num_bits n] -> i64
  ...
  --
  -- **Span:** *O(log n)*
  val (==) [n] : bitset [cap num_bits n] -> bitset [cap num_bits n] -> bool
  ...
  --
  -- **Span:** *O(m)* (likely *O(1)*, the span comes from reduce by index.)
  val from_array [m] : (n: i64) -> [m]i64 -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(1)*
  val from_bit_array [m] : (n: i64) -> (arr: [m]u64) -> *bitset [cap num_bits n]
  ...
  --
  -- **Span:** *O(log n)*
  val to_array [n] : bitset [cap num_bits n] -> *[]i64
}
...
module mk_bitset (I: integral) : bitset = {
  ...
  def empty (n: i64) : *bitset [cap num_bits n] =
    replicate (cap num_bits n) zero
  ...
  def singleton (n: i64) (i: i64) : *bitset [cap num_bits n] =
    let set = empty n
  ...
  def member [n] (i: i64) (s: bitset [cap num_bits n]) : bool =
    let (i, bit) = find_bitset_index i n
    in if i < 0 || bit < 0
       then false
       else I.get_bit bit s[i] == 1

  def union [n] (a: bitset [cap num_bits n]) (b: bitset [cap num_bits n]) : *bitset [cap num_bits n] =
    map2 (I.|) a b
  ...
  def complement [n] (set: bitset [cap num_bits n]) : *bitset [cap num_bits n] =
    map I.not set
    |> set_trailing_bits_zero

  def size [n] (s: bitset [cap num_bits n]) : i64 =
    map (i64.i32 <-< I.popc) s
    |> i64.sum

  def (==) [n] (a: bitset [cap num_bits n]) (b: bitset [cap num_bits n]) : bool =
    map2 (I.==) a b
    |> and

  def is_subset [n] (a: bitset [cap num_bits n]) (b: bitset [cap num_bits n]) : bool =
    (a `union` b) == b

  def difference [n] (a: bitset [cap num_bits n]) (b: bitset [cap num_bits n]) : *bitset [cap num_bits n] =
    a `intersection` complement b

  def set_capacity [m] (n: i64) (set: bitset [cap num_bits m]) : *bitset [cap num_bits n] =
    let s' = empty n
    let len = length set
    in map (\i ->
  ...
  def from_bit_array [m] (n: i64) (arr: [m]u64) : *bitset [cap num_bits n] =
    map (I.u64) arr
    |> sized (cap num_bits n)
    |> set_trailing_bits_zero

  def from_array [m] (n: i64) (arr: [m]i64) : *bitset [cap num_bits n] =
    copy (insert (empty n) arr)

  def to_array [n] (s: bitset [cap num_bits n]) : *[]i64 =
    map2 (\i v ->
