...
def next [nx] [ny] [nz] (c0: f32) (c1: f32) (A0: [nx][ny][nz]f32) (i: i32) (j: i32) (k: i32) : f32 =
  -- We map the edge to itself.
  #[unsafe]
  if i == 0 || i == i32.i64 nx - 1 || j == 0 || j == i32.i64 ny - 1 || k == 0 || k == i32.i64 nz - 1
  then A0[i, j, k]
...
def main [ny] [nz] (iterations: i32) (nx: i32) (A0_slice: [ny][nz]f32) : [ny][nz]f32 =
  -- c0 and c1 are also hardcoded in Rodinia.
  let c0 = 1.0f32 / 6.0f32
  let c1 = 1.0f32 / 6.0f32 / 6.0f32
  let nx = i64.i32 nx
  let A0 =
    loop A0 = replicate nx A0_slice
