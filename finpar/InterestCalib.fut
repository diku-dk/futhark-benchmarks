...
fun mutate_dims_all(tup: ([]f32,[]f32,[]f32)): (*[]f32,f32) = 
...
fun perturbation(gamma1:  f32, ampl_rat: f32, gene: f32,
		       gene_k: f32, gene_l: f32,   r01: f32, mm_diff: f32 ): f32 =
