...
let project_bottom_outer_base [g]
                             (i: i32,
                              j: i32,
                              p0: [g][g]f32,
                              s0: [g][g]f32,
