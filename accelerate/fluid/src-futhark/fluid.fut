...
fun inside(i: i32, j: i32, g: i32): bool =
  i >= 1 && i <= g - 2
  && j >= 1 && j <= g - 2

fun in_outside_corner(i: i32, j: i32, g: i32): bool =
  (i == 0 || i == g - 1) && (j == 0 || j == g - 1)

fun corner_index_neighbors(i: i32, j: i32, g: i32): (i32, i32, i32, i32) =
  if i == 0 && j == 0
  then (1, 0, 0, 1)
  else if i == 0 && j == g - 1
  then (1, g - 1, 0, g - 2)
...
fun outermost_inner_index(i: i32, j: i32, g: i32, b: i32): (i32, i32, f32) =
  if i == 0
