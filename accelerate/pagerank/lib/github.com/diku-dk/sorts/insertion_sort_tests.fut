...
entry sort_i32 (xs: []i32) = insertion_sort (i32.<=) xs
...
entry sort_u16 (xs: []u16) = insertion_sort (u16.<=) xs
...
entry sort_f32 (xs: []f32) = insertion_sort (f32.<=) xs
