...
entry prod_mat4_i32 = map mat4 >-> reduce (mat4_mul (i32.+) (i32.*)) (1, 0, 0, 1)
entry prod_mat4_f32 = map (r32 >-> mat4) >-> reduce (mat4_mul (f32.+) (f32.*)) (1, 0, 0, 1)
entry prod_mat4_f64 = map (r64 >-> mat4) >-> reduce (mat4_mul (f64.+) (f64.*)) (1, 0, 0, 1)
