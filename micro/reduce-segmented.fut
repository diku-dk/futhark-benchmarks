...
entry sum_iota_i32 n m: []i32 = array i32.i32 n m |> map i32.sum
...
entry sum_i8 n m xs: []i8 = unflatten n m xs |> map i8.sum
...
entry sum_i16 n m xs: []i16 = unflatten n m xs |> map i16.sum
...
entry sum_i32 n m xs: []i32 = unflatten n m xs |> map i32.sum
...
entry sum_i64 n m xs: []i64 = unflatten n m xs |> map i64.sum
...
entry prod_mat4_i32 n m as bs cs ds =
  let ass = unflatten n m as
  let bss = unflatten n m bs
